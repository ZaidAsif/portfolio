...
export default function HomeSection() {
    return (
        <div className="z-10 flex flex-wrap h-screen w-full gap-8 "> 
            ...
            <img className="opacity-100 md:opacity-0 lg:opacity-0" src="https://firebasestorage.googleapis.com/v0/b/nextjs-with-firebase-935b3.appspot.com/o/images%2Fcoderboy.gif?alt=media&token=10e04cfe-2180-49b9-8700-8ea76f9fddc1" alt="coding-boy" />

                <div style={{ color: '#00ffd9', textShadow: "2px 2px 4px rgba(134, 219, 219, 0.6)" }} className={`motion-preset-slide-right motion-delay-200 text-3xl w-full font-semibold md:text-4xl lg:text-4xl ${roboto.className} text-primary`}>
                    Hello, Myself
                </div>
